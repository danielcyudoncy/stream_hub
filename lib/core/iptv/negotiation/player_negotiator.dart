...
/// Android because it renders through a plain SurfaceView composited by
/// SurfaceFlinger, which is the only render path that displays video on
      ...
      case StreamProtocol.hls:
        return PlayerNegotiation(
          ...
          reason:
              ...
              'SurfaceView, composited by SurfaceFlinger), bypassing Flutter '
      ...
      case StreamProtocol.mpegTs:
        return PlayerNegotiation(
          ...
          reason:
              ...
              '(ExoPlayer progressive extractor + SurfaceView) for reliable '
