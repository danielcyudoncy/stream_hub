...
class HDHomeRunSource implements MediaSource {
  @override
  final String id;
  @override
  MediaSourceType get type => MediaSourceType.hdHomeRun;
  @override
  MediaSourceState get state => MediaSourceState.created;
  @override
  MediaEventBus? get eventBus => null;

  HDHomeRunSource({required this.id, Map<String, dynamic>? config});
