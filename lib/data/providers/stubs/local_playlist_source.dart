...
class LocalPlaylistSource implements MediaSource {
  @override
  final String id;
  @override
  MediaSourceType get type => MediaSourceType.localPlaylist;
  @override
  MediaSourceState get state => MediaSourceState.created;
  @override
  MediaEventBus? get eventBus => null;

  LocalPlaylistSource({required this.id, Map<String, dynamic>? config});
