...
abstract class VlcPlayerPlatform extends PlatformInterface {
  ...
  /// Return all subtitle tracks as array of `Int` to `String`
  ...
  /// Returns all audio tracks as array of `Int` to `String`
  ...
  /// Returns all video tracks as array of `Int` to `String`
  ...
  /// Returns all detected renderer devices as array of `String` to `String`
